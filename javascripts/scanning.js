...
function ScanningController () {
    ...
    this.settings = [
        ...
        {'name':              'Search for me on Facebook',
         'type':              'dropdown',
         'id':                '8787330733',
         'recommended_level': DROPDOWN_VALUE_ALL, },
        {'name':              'Send me friend requests',
         'type':              'dropdown',
         'id':                '8787540733',
         'recommended_level': DROPDOWN_VALUE_ALL, },
        {'name':              'Send me messages',
         'type':              'dropdown',
         'id':                '8787545733',
         'recommended_level': DROPDOWN_VALUE_ALL, },
        {'name':              'See my friend list',
         'type':              'dropdown',
         'id':                '8787365733',
         'recommended_level': DROPDOWN_VALUE_FRIENDS, },
        {'name':              'See my education and work',
         'type':              'dropdown',
         'id':                '8787515733',
         'recommended_level': DROPDOWN_VALUE_ALL, },
        {'name':              'See my current city and hometown',
         'type':              'dropdown',
         'id':                '8787610733',
         'recommended_level': DROPDOWN_VALUE_FRIENDS_AND_NETWORKS, },
        {'name':              'See my interests and other pages',
         'type':              'dropdown',
         'id':                '8787615733',
         'recommended_level': DROPDOWN_VALUE_FRIENDS_OF_FRIENDS, },
    ];
